...
ssh -i ~/.ssh/shepherd root@45.55.226.192 "php /var/www/tools/srdb.cli.php -h localhost -n wordpress -u wordpress -p XCbKSzHzvy -s goodshepherd.dev -r 45.55.226.192"
